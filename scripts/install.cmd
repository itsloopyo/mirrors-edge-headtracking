...
set "MOD_CONTROLS=Controls: Home / Ctrl+Shift+T = recenter, End / Ctrl+Shift+Y = toggle tracking, PageUp / Ctrl+Shift+G = toggle 6DOF position, PageDown / Ctrl+Shift+H = toggle yaw mode."
